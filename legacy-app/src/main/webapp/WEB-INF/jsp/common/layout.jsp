...
<head>
    ...
    <style>
        ...
        header a { color: #ecf0f1; text-decoration: none; font-size: 1.2em; font-weight: bold; }
        ...
        form input, form select { width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; margin-bottom: 4px; }
        .error-message { color: #e74c3c; font-size: 12px; margin-bottom: 8px; }
        .form-group { margin-bottom: 16px; }
    </style>
</head>
<body>
<header>
    <a href="<s:url action='list' namespace='/book'/>">図書館管理システム</a>
    <nav>
...
<main>
    <jsp:include page="${pageContext.request.getAttribute('content')}"/>
</main>
</body>
</html>
